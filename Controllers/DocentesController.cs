...
namespace IndiC_API.Controllers
{
    ...
    public class DocentesController : ControllerBase
    {
        ...
        public DocentesController(IndiCContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Docente>> PostDocente(Docente docente)
        {
          if (_context.Docentes == null)
          {
              return Problem("Entity set 'IndiCContext.Docentes'  is null.");
          }
        ...
        {
            return (_context.Docentes?.Any(e => e.IdDocente == id)).GetValueOrDefault();
        }
    }
}
